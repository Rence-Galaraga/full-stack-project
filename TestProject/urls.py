...
# from TestProject.myapp.views import index
...
urlpatterns = [
    ...
    path('movies/detail/<int:movie_id>',
         movies_views.detail, name='movie_detail'),
    path('movies/create/', movies_views.create, name='movie_create'),
    path('movies/update/', movies_views.update, name='movie_update'),
    path('movies/update/<int:movie_id>',
         movies_views.update, name='movie_update'),
    path('courses/list/', CoursesView.as_view()),
    path('courses/create/', CreateCourseView.as_view()),
    path('courses/<int:course_id>/students',
         StudentApiView.as_view(), name='students_list'),
